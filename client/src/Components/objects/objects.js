                ...
                <div className="Dashboard-body">
                    <div className="Sidebar">
                        <ul className="Sidebar-ul">
                            ...
                            <li className={state === 6 ? "Sidebar-liactive" : "Sidebar-li"} onClick={() => setState(6)}><i class="fa-solid fa-user" /><p className="Sidebar-lable">Edit Profile</p></li>
...
const VendorDashboard = () => {
    ...
    if (!loading) {
        return (
            <div>
                {/* <h1 className="Welcome-block">Welcome, {vendorName.Username}</h1> */}
                <MenuBar />

                <div className="Dashboard-body">
                    <div className="Sidebar">
                        <div className="Vendor-Details">
                            {Array.isArray(vendorName.PhotoFiles) && vendorName.PhotoFiles.map((item, index) => (
                                <img className="ProfileImg-Vendor" src={localpath + item.filename} alt="profImg" key={index} />

                            ))}
                            <h3 className="Vendor-Name">{capitalize(vendorName.Username)}</h3>
                        </div>
                        <ul className="Sidebar-ul">
                            <li className={state === 1 ? "Sidebar-liactive" : "Sidebar-li"} onClick={() => setState(1)}><i class="fa-solid fa-user" /><p className="Sidebar-lable">My Profile</p></li>
