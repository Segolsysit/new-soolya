...
const RecivedApplication = ({ formNumber }) => {
    ...
    const handleOpen = (_id) => {
        // console.log("hii")
        axios.get(`http://backend.kooblu.com/vendor_Applications/fetchVendor_id/${_id}`).then((res) => {
    ...
    const handleVendorAuth = async (e) => {
        ...
        if (vendorPwd === '') {
            ...
            const response = await axios.post("http://backend.kooblu.com/vendor_Auth/register", {
                Username: vendorName,
                Email: vendorEmail,
                Password: vendorPwd,
                Phonenumber: Phone
    ...
    const deleteapplication = () => {
        axios.delete(`http://backend.kooblu.com/vendor_Applications/delete_item/${viewdata._id}`)
    }

    const reject_data = () => {
        // e.preventDefault()
        // console.log(viewdata)
        axios.post("http://backend.kooblu.com/reject_api/new_rejection", {
            ...
            .then(() => {
                axios.delete(`http://backend.kooblu.com/vendor_Applications/delete_item/${viewdata._id}`).then(() => {
    ...
    const getdata = () => {
        axios.get("http://backend.kooblu.com/vendor_Applications/vendor_application").then((res) => {
