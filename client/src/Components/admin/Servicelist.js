   ...
   // const [orderdetails, setorderdetails] = useState([])
    ...
    const AddService = (e) => {
        ...
        if (service.length === 0) {
            ...
            axios.post("http://backend.kooblu.com/service_api/new_service/", formdata).then((res) => {
    ...
    const EditList = (id) => {
        handleOpen()
        axios.get(`http://backend.kooblu.com/service_api/new_fetch_service_items/${id}`).then((res) => {
    ...
    const saveChangeList = (e) => {
        ...
        axios.patch(`http://backend.kooblu.com/service_api/update_service/${getByIdList._id}`, formData).then(() => {
            alert("ListUpdated")
        })
    ...
    useEffect(() => {
       // verify()
        ...
        axios.get("http://backend.kooblu.com/service_api/new_fetch_service_items").then((res) => {
    ...
    const delete_list = (id) => {
        axios.delete(`http://backend.kooblu.com/service_api/delete_item/${id}`).then(() => {
